                ...
                with open(out_conllu_fname, 'w') as outfile:
                    for sent in sentences:
                        for token in sent['tokens']:
                            ...
                            outfile.write(' | '.join([word, "-".join(morphs), analysis]) + '\n')
